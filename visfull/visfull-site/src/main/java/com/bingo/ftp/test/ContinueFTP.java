...
public static void main(String[] args) {  
   ...
   try {  
    myFtp.connect("192.168.5.112", 21, "anonymous", "anonymous");  
...
//    System.out.println(myFtp.upload("E:\\走西口24.mp4","/央视走西口/新浪网/走西口24.mp4"));  
      System.out.println(myFtp.download("pub/software/office/OFFICE12_SP1.ISO", "F:\\OFFICE12_SP1.ISO"));  
    myFtp.disconnect();  
   } catch (IOException e) {  
