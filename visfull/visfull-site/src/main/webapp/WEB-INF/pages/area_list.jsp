...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			<li><a class="add" target="navTab" rel="addNavTab"  href="${ctx}/bz/initaddarea" title="添加"><span>添加</span></a></li>
			<li><a class="edit" target="navTab" rel="editnavTab" href="${ctx}/bz/initeditarea/{slt_objId}" title="编辑"><span>编辑</span></a></li>
